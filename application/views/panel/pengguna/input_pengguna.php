                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <span class="input-group-addon">
                                                <i class="material-icons">block</i>
                                                    ...
                                                    <div class="form-line">
                                                        <div class="switch">
                                                            <label>Aktif<input type="checkbox" name="aktif" id="aktif"><span class="lever"></span>Suspend</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <span class="input-group-addon">
                                                <i class="material-icons">map</i>
                                                    ...
                                                    <div class="form-line">
                                                        <select class="form-control show-tick" id="kecamatan" name="idkecamatan" data-live-search="true" required>
                                                            <option value=""></option>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <span class="input-group-addon">
                                                <i class="material-icons">map</i>
                                                    ...
                                                    <div class="form-line">
                                                        <select class="form-control show-tick" id="kelurahan" name="idkelurahan" data-live-search="true" required>
                                                            <option value=""></option>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <span class="input-group-addon">
                                                <i class="material-icons">map</i>
                                                    ...
                                                    <div class="form-line">
                                                        <select class="form-control show-tick" id="lingkungan" name="idlingkungan" data-live-search="true" required>
                                                            <option value=""></option>
                                                        </select>
                                                    </div>
                                                </div>
