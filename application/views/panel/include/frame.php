...
<head>
    ...
    <title><?php echo $title;?> | AdminWILAYAH</title>
    <!-- Favicon-->
    <link rel="icon" href="<?php echo base_url("/assets/images/user.png");?>" type="image/x-icon">
...
<nav class="navbar">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo base_url(); ?>">ADMINWILAYAH - MATERIAL DESIGN</a>
        </div>
...
<section>
    <!-- Left Sidebar -->
    <?php $this->load->view("panel/include/leftside"); ?>
    <!-- #END# Left Sidebar -->
    <!-- Right Sidebar -->
    <?php $this->load->view("panel/include/rightside"); ?>
    <!-- #END# Right Sidebar -->
</section>